  ...
  return (
    ...
    <div>
      ...
      <div className = "absolute mt-10">
        <StatTestIndicator text = "testttdsfasdfasdfttt" clicked={clicked} phaseNum={1}/>
      </div>
      ...
      {/* <AnimatePresence>
        ...
        {/* 1 Cleaning Data*/}
        <p className={clicked>0 ?"text-[17px] absolute left-10":"absolute left-10 loading"}>
          Loading data
        </p>

        {/* 2 Finding patterns */}
        {clicked > 0 && <div>
          <p className={clicked>1 ?"text-[17px] absolute left-10 mt-6":"absolute left-10 loading mt-6"}>
          Finding patterns 
          </p>
        ...
        {clicked > 1 && <div>
          <p className={clicked>2 ?"text-[17px] absolute left-10 mt-12":"absolute left-10 loading mt-12"}>
        ...
        {/* Found Data!*/}
        {clicked > 2 && <div>
          <p className="text-[17px] absolute left-10 mt-18">
          Found Data!
          </p>
